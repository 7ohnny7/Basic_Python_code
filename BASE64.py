...
base64_message = "Q2F0" #encoded message
...
#Lines 7–21 print the message, the byte representation, the Base64 representation and the encoded output. Each line is printed one character at a time.
